...
"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_get_struct_18h().pack(*self.data))
      _x = self
      buff.write(_get_struct_2bh().pack(_x.size, _x.command, _x.speed))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.data = _get_struct_18h().unpack(str[start:end])
      _x = self
      start = end
      end += 4
      (_x.size, _x.command, _x.speed,) = _get_struct_2bh().unpack(str[start:end])
      return self
